define([], () => {
	...
	var _paletton = null;
		...
		var localcolor = {
			...
			,'chars/lance' : {"byPalette":{"pri":["#945B73","#D6B5C3","#B18296","#763F56","#62233D"]},"byLum":{"pri":["#D6B5C3","#B18296","#945B73","#763F56","#62233D"]}}
			,'chars/krismorel' : {"byPalette":{"pri":["#010001","#A4A4A4","#909090","#010001","#000001"]},"byLum":{"pri":["#A4A4A4","#909090","#010001","#010001","#000001"]}}
			, 'chars/pepper' : {"byPalette":{"pri":["#406868","#7F9797","#5B7D7D","#2C5353","#194545"]},"byLum":{"pri":["#7F9797","#5B7D7D","#406868","#2C5353","#194545"]}}
		}
